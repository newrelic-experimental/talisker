...
let INSERT_KEY=$secure?.YOUR_SECURE_CRED_CONTAINING_INSERT_KEY || "YOUR-INGEST-API-KEY"; //use secure credentials if possible!
let QUERY_KEY=$secure?.YOUR_SECURE_CRED_CONTAINING_QUERY_KEY || "YOUR-USER-API-KEY"; //use secure credentials if possible!
